"""Sentence explanation strategy: plain-English meaning, up to five sentences."""
...
class SentenceExplanationStrategy:
    ...
    async def explain(
        ...
        *,
        ...
        prompt = render_sentence_explanation_prompt(
            sentence=selected_text, context=context, book_title=book_title
        )
